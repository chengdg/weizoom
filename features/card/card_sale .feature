...
Scenario:1.发放发售卡
	...
	Then 'test'能获得通用卡'微众卡'库存列表
		| card_number  |status| money |rest_money|comments|apply_person|apply_department| 
		|  010000001   |已出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000002   |已出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000003   |已出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000004   |待出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000005   |待出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000006   |待出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000007   |待出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000008   |待出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000009   |待出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
		|  010000010   |待出库| 10.00 |  10.00   | 微众卡 |   纳容     |    南京纳容    |
...
Scenario:2.发放发售卡
	...
	Then 'test'能获得限制卡'测试卡1'的库存列表
		...
		| card_number  |status| money |rest_money| comments|apply_person|apply_department| 
		|  020000001   |已出库| 10.00 |  10.00   | weizoom |    微众    |    北京微众    |
		|  020000002   |已出库| 10.00 |  10.00   | weizoom |    微众    |    北京微众    |
		|  020000003   |已出库| 10.00 |  10.00   | weizoom |    微众    |    北京微众    |
		|  020000004   |待出库| 10.00 |  10.00   | weizoom |    微众    |    北京微众    |
		|  020000005   |待出库| 10.00 |  10.00   | weizoom |    微众    |    北京微众    |
...
Scenario:3.发放发售卡
	...
	Then 'test'能获得通用卡'10元卡'的库存列表
		...
		| card_number  |status| money |rest_money|comments|apply_person|apply_department| 
		|  020000001   |已出库| 10.00 |  10.00   | 微众卡 |    研发    |    窝夫小子    |
		|  020000002   |已出库| 10.00 |  10.00   | 微众卡 |    研发    |    窝夫小子    |
		|  020000003   |已出库| 10.00 |  10.00   | 微众卡 |    研发    |    窝夫小子    |
		|  020000004   |已出库| 10.00 |  10.00   | 微众卡 |    研发    |    窝夫小子    |
		|  020000005   |待出库| 10.00 |  10.00   | 微众卡 |    研发    |    窝夫小子    |
	Then 'test'能获得限制卡'测试卡1'的库存列表
		| card_number  |status| money |rest_money|comments|apply_person|apply_department| 
		|  030000001   |已出库| 10.00 |  10.00   | weizoom|    研发    |    窝夫小子    |
		|  030000002   |已出库| 10.00 |  10.00   | weizoom|    研发    |    窝夫小子    |
		|  030000003   |已出库| 10.00 |  10.00   | weizoom|    研发    |    窝夫小子    |
		|  030000004   |待出库| 10.00 |  10.00   | weizoom|    研发    |    窝夫小子    |
		|  030000005   |待出库| 10.00 |  10.00   | weizoom|    研发    |    窝夫小子    |
