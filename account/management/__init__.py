...
#===============================================================================
# init_weizoom_card : 初始化role与group
#===============================================================================
def init_weizoom_card(app, created_models, verbosity, **kwargs):
...
signals.post_syncdb.connect(init_weizoom_card, sender=account_models, dispatch_uid = "weizoom_card.init_weizoom_card")
