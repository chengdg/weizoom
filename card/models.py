...
#订单状态
WEIZOOM_CARD_ORDER_STATUS_CANCANCLE = 0  #未取消
WEIZOOM_CARD_ORDER_STATUS_CANCLED = 1  #已取消
WEIZOOM_CARD_ORDER_STATUS2TEXT = {
	WEIZOOM_CARD_ORDER_STATUS_CANCANCLE: u'未取消',
	WEIZOOM_CARD_ORDER_STATUS_CANCLED: u'已取消'
}
