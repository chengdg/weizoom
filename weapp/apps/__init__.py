...
try:
	...
	connect(settings.MARKET_APP_MONGO['DB'], host=settings.MARKET_APP_MONGO['HOST'], alias=settings.MARKET_APP_MONGO['ALIAS'], username=settings.MARKET_APP_MONGO['USERNAME'], password=settings.MARKET_APP_MONGO['PASSWORD'])
except:
