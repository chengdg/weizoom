...
class weizoom_eventParticipance(models.Document):
	...
	meta = {
		'collection': 'weizoom_event_weizoom_event_participance'
	}
...
STATUS_RUNNING = 1
STATUS_STOPED = 2
class weizoom_event(models.Document):
	...
	meta = {
		'collection': 'weizoom_event_weizoom_event'
	}
