...
class weizoom_eventStatus(resource.Resource):
	app = 'apps/weizoom_event'
	resource = 'weizoom_event_status'
	...
	def api_post(request):
		...
		app_models.weizoom_event.objects(id=request.POST['id']).update(set__status=target_status)
