...
class ScanlotteryParticipances(resource.Resource):
	app = 'apps/scanlottery'
	resource = 'scanlottery_participances'
	...
	def get(request):
		...
		return render_to_response('scanlottery/templates/editor/scanlottery_participances.html', c)
...
class ScanlotteryParticipances_Export(resource.Resource):
	'''
	批量导出
	'''
	app = 'apps/scanlottery'
	resource = 'scanlottery_participances-export'
	@login_required
	def api_get(request):
		"""
		详情导出
