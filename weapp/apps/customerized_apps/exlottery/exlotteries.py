...
class Exlotteries(resource.Resource):
	app = 'apps/exlottery'
	resource = 'exlotteries'
	...
	def get_datas(request):
		...
		datas_datas = app_models.Exlottery.objects(**params)
		...
		datas = app_models.Exlottery.objects(**params).order_by('-id')	
	...
	def api_get(request):
		...
		响应API GET
		"""
		pageinfo, datas = Exlotteries.get_datas(request)
