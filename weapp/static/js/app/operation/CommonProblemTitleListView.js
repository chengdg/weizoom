 ...
 * @class
 */
W.CommonProblemTitleListView = Backbone.View.extend({
    el: '',
    ...
    initialize: function(options) {
	   ...
	   //this.siteDomain = options.siteDomain;
        ...
        var _this = this.agendaId;
        //this.menus = new W.AgendaDetailMenus(null, {agendaId:_this});
        this.menus = new W.ProblemTitles();
        this.menus.agendaId = _this
    ...
    submitForSort: function() {
        ...
        xlog('----------');
        xlog(sortedCategoryIds);

        W.getApi().call({
            app: 'operation',
            api: 'problem_titles/display_index/update',
            args: {
