    ...
    initialize: function(options) {
        ...
        if (this.type == 'text') {
        	$.extend(this.editorOptions, {
                toolbars: [['link', 'emotion', 'fullscreen']]
        	});
            ...
            $.extend(this.editorOptions, {
                toolbars: [['bold', 'italic', 'underline', "forecolor", "backcolor", '|', "insertunorderedlist","insertorderedlist", '|', 'link', 'emotion', 'insertimage', 'fullscreen'],
                            ['justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'paragraph', 'fontfamily', 'fontsize', '|', "inserttable", '|', "removeformat"]]
            });
