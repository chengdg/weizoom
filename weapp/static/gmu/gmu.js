/* Gmu v2.1.0 - core/gmu.js, core/event.js, extend/parseTpl.js, core/widget.js, extend/detect.js, extend/matchMedia.js, extend/event.ortchange.js, extend/throttle.js, extend/event.scrollStop.js, extend/fix.js, extend/highlight.js, extend/iscroll.js, extend/offset.js, extend/position.js, extend/support.js, extend/touch.js */
...
(function( gmu, $, undefined ) {
    var slice = [].slice,
        ...
        record = (function() {
            ...
            //robert: 通过obj['_gid']获取一个id值，比如(3)，然后从data[3]中获取真实的value
    ...
    function zeptolize( name ) {
        //robert: key的算法: 将'ButtonImage'转化为'buttonImage';
        ...
        $.fn[ key ] = function( opts ) {
            ...
            window.ddd = this;
            //robert: 如果调用$('.button').button()，则$('.button')——也就是this——可能是一个collection
            //所以这里要遍历this, 对每一个.button元素进行相同的操作
        ...
        eachObject( record( klass, 'plugins' ), function( opt, plugin ) {
            ...
            eachObject( plugin, function( key, val ) {
                ...
                if ( $.isFunction( val ) && (oringFn = me[ key ]) ) {
                    //robert: 使用plugin中的函数替换widget中的同名函数
                    me[ key ] = function() {
    ...
    $.fn.highlight = function( className, selector ) {
        return this.each(function() {
            ...
            className && $this.on( 'touchstart.hl', function( e ) {
                ...
                // selctor可能找不到元素。
                if ( $el ) {
                    $el.attr( 'hl-cls', className ); //robert: 利用hl-cls attr来记录用来高亮效果的class名，以便在dismiss中知道remove哪个class
