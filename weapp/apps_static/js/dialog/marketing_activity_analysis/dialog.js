...
W.weapp.dialog.MarketingActivityNetworkDialog = W.dialog.Dialog.extend({
    ...
    getTemplate: function() {
        $('#marketing-activity-analysis-dialog-tmpl-src').template('marketing-activity-analysis-dialog-tmpl');
        return "marketing-activity-analysis-dialog-tmpl";
    },

    onInitialize: function(options) {

        // this.$dialog.find('.modal-body').html('');
        //this.$dialog.find('.modal-body').html($.tmpl(this.tmplName));
        ...
        //chart = echarts.init(document.getElementById('activityNetworkChart0'));
    ...
    onShow: function(options) {
        ...
        W.getApi().call({
            ...
            success: function(data) {
                ...
                //_this.activityNetworkChart.setOption(option, true);
                _this.activityNetworkChart = echarts.init(document.getElementById('activityNetworkChart'));
                _this.activityNetworkChart.setOption(data, true);
            }
        });
    },
