...
from apps.customerized_apps.shengjing.models import ShengjingBindingMember, ShengjingBindingMemberInfo
from core import paginator

from core import resource
from core.jsonresponse import create_response
from member.api_views import  _get_tags_json
from member.member_list import build_member_has_tags_json
from modules.member.models import SUBSCRIBED, CANCEL_SUBSCRIBED, MemberHasTag, Member, MemberFollowRelation
from utils.string_util import byte_to_hex
from weixin2.models import get_opid_from_session
from modules.member import module_api

COUNT_PER_PAGE = 20
class issuingCouponMembers(resource.Resource):
	app='member'
	resource='issuingcoupon_members'
	...
	def api_get(request):
		...
		URL: http://weapp.weizoom.com/member/api/issuingcoupon_members/?design_mode=0&version=1&filter_value=pay_times:0-1|first_pay:2015-04-08%2000:00--2015-04-30%2000:00&page=1&count_per_page=50&enable_paginate=1&timestamp=1435216368297&_=1435215905446
