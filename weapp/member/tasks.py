	...
	if type == 0:
		try:
			...
			for member in members:
				...
				# ship_infos = ShipInfo.objects.filter(webapp_user_id__in=webapp_user_ids,is_selected=True)
				# if ship_infos:
				# 	ship_name = ship_infos[0].ship_name
				# 	ship_tel = ship_infos[0].ship_tel
				# 	ship_address = ship_infos[0].ship_address
				# else:
				# 	ship_name = ''
				# 	ship_tel = ''
				# 	ship_address = ''
