...
class Orders(api_resource.ApiResource):
	...
	def get(args):
		...
		result = Orders.get_order_items(user,found_begin_time,found_end_time,pay_begin_time,pay_end_time)
		return result

	# get_orders_response调用
	@staticmethod
	def get_order_items(user,found_begin_time,found_end_time,pay_begin_time,pay_end_time):
