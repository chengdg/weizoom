...
class GetQrcodeApiTestCase(unittest.TestCase):
	dummy_access_token_str  = 'sdbR_0VcwJitp9B-h8H-9AH0m6tXGN9t6rbyM_tJsbSS1qgU25R0Bo9C29GcBM1kevDiARj6a-zB3IksfXZ6Q6o8yODJnTSuO_T2DpbtSsX_-iAn1A13aS4eDm2VnPY3cfrVdbNceA-o8law3jgRg6Q'
	...
	def test_userinfo_get(self):
		...
		ticket = 'gQHd8DoAAAAAAAAAASxodHRwOi8vd2VpeGluLnFxLmNvbS9xL1hFUHQyVmpsS3kxU1U0UzJ2VzJEAAIEEZVQUwMECAcAAA=='
		result = self.api.get_qrcode(ticket)
