...
class WeixinApiTestCase(unittest.TestCase):
	dummy_access_token_str  = '1ZwSKl32BCCUNWcyAlLQjeYyvCFMo9LGszvY8lUn40VlJS5xfep0BJf9lf357ZCW_H2L0hCwMk0ZrmD0CSBcQShdlWUm98fUNmCzw2ozE4DteByVbDxaIOuDtvjh5meSHvBVkUSbixlYTnnP_fKmX7w'
	...
	def test_userinfo_get(self):
		...
		result = self.api.get_user_info('1oR3uquP43phGnoBZoAakpXuo6meY')
		# excepted_url_parts = [
