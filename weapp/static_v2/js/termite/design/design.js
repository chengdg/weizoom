...
W.data.getDynamicComponentDataForDialogSelectControl = function(dynamicComponent, dynamicComponentField) {
	...
	if (dynamicComponentField.dialog === 'W.dialog.workbench.SelectLinkTargetDialog') {
        ...
        if (product.productId != "") {
			html = '<table class="table table-bordered xb-stripedTable xa-productTable propertyGroup_property_dialogSelectField  xa-productList" style="width:430px;"><thead style="background:#c8d2e5;"><tr><th width="165">商品信息</th><th width="105">商品价格(元)</th><th width="70">总销量</th></tr></thead><tbody><tr data-id="${product.id}"><td class="text_nowrap" style="min-width:180px;"><img class="productImg" id="productImg" style="width: 60px;height: 60px;float: left;margin: 2px;" src="'+product.productImg+'"><p class="productName" style="color: #1360B8;width: 140px;float: left;text-align: left;padding-left: 0.5rem;word-wrap: break-word;word-break: break-all;white-space: normal;">'+product.productName+'</p><p class="productUserCode" style="line-height: 16px;color: #676767;width: 95px;float: left;text-align: left;padding-left: 0.5rem;">商品编码:'+product.productUsercode+'</p></td><td class="productPrice" >'+product.productPrice+'</td><td class="productSales">'+product.productSales+'</td></tr></tbody></table>';
        } else {
			html = '<table class="table table-bordered xb-stripedTable xa-productTable propertyGroup_property_dialogSelectField  xa-productList xui-hide" style="width:430px;"><thead style="background:#c8d2e5;"><tr><th width="165">商品信息</th><th width="105">商品价格(元)</th><th width="70">总销量</th></tr></thead><tbody><tr data-id="${product.id}"><td class="text_nowrap" style="min-width:180px;"><img class="productImg" id="productImg" style="width: 60px;height: 60px;float: left;margin: 2px;" src="'+product.productImg+'"><p class="productName" style=";color: #1360B8;width: 140px;float: left;text-align: left;padding-left: 0.5rem;word-wrap: break-word;word-break: break-all;white-space: normal;">'+product.productName+'</p><p class="productUserCode" style="line-height: 16px;color: #676767;width: 95px;float: left;text-align: left;padding-left: 0.5rem;">商品编码:'+product.productUsercode+'</p></td><td class="productPrice" >'+product.productPrice+'</td><td class="productSales">'+product.productSales+'</td></tr></tbody></table>';
		}
    }
