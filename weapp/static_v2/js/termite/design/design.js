...
W.data.getDynamicComponentDataForDialogSelectControl = function(dynamicComponent, dynamicComponentField) {
	...
	if (dynamicComponentField.dialog === 'W.dialog.workbench.SelectLinkTargetDialog') {
        ...
        if (product.productId != "") {
			html = '获得数据<table class="table table-bordered xb-stripedTable xa-productTable propertyGroup_property_dialogSelectField  xa-productList"><thead style="background:#c8d2e5;"><tr><th width="165">商品信息</th><th width="105">商品价格(元)</th><th width="70">总销量</th></tr></thead><tbody><tr data-id="${product.id}"><td class="text_nowrap" style="min-width:180px;"><img class="productImg" id="productImg" style="width: 60px;height: 60px;float: left;margin: 2px;" src="'+product.productImg+'"><p class="productName" style="line-height: 30px;color: #1360B8;width: 95px;float: left;text-align: left;padding-left: 0.5rem;">'+product.productName+'</p><p class="productBarCode" style="line-height: 16px;color: #676767;width: 95px;float: left;text-align: left;">商品编码:'+product.productBarcode+'</p></td><td class="productPrice" >'+product.productPrice+'</td><td class="productSocks">'+product.productSocks+'</td></tr></tbody></table>';
        } else {
			html = '无数据<table class="table table-bordered xb-stripedTable xa-productTable propertyGroup_property_dialogSelectField  xa-productList xui-hide"><thead style="background:#c8d2e5;"><tr><th width="165">商品信息</th><th width="105">商品价格(元)</th><th width="70">总销量</th></tr></thead><tbody><tr data-id="${product.id}"><td class="text_nowrap" style="min-width:180px;"><img class="productImg" id="productImg" style="width: 60px;height: 60px;float: left;margin: 2px;" src="'+product.productImg+'"><p class="productName" style="line-height: 30px;color: #1360B8;width: 95px;float: left;text-align: left;padding-left: 0.5rem;">'+product.productName+'</p><p class="productBarCode" style="line-height: 16px;color: #676767;width: 95px;float: left;text-align: left;">商品编码:'+product.productBarcode+'</p></td><td class="productPrice" >'+product.productPrice+'</td><td class="productSocks">'+product.productSocks+'</td></tr></tbody></table>';
		}
    }
