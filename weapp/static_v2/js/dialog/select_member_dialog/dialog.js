...
W.dialog.mall.SelectMemberDialog = W.dialog.Dialog.extend({
    events: _.extend({
    ...
    getTemplate: function() {
        $('#select-member-dialog-tmpl-src').template('select-member-dialog-tmpl-src-dialog-tmpl');
        return "select-member-dialog-tmpl-src-dialog-tmpl";
    },
    ...
    onInitialize: function(options) {
        ...
        $.tmpl(this.getTemplate(), {selectedMemberIds: options.selectedMemberIds});
