...
W.dialog.weixin.SelectSingleMaterialDialog = W.dialog.Dialog.extend({
    events: _.extend({
    ...
    getTemplate: function() {
        $('#weixin-select-single-material-dialog-tmpl-src').template('weixin-select-single-material-dialog-tmpl');
        return "weixin-select-single-material-dialog-tmpl";
    },
