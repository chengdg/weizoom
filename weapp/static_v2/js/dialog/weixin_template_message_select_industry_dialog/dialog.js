...
W.dialog.weixin.SelectIndustryDialog = W.dialog.Dialog.extend({
    events: _.extend({
    ...
    getTemplate: function() {
        $('#weixin-template-message-select-industry-dialog-tmpl-src').template('weixin-template-message-select-industry-dialog-tmpl');
        return "weixin-template-message-select-industry-dialog-tmpl";
    },
