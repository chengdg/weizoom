...
W.view.common.WeixinECharts = Backbone.View.extend({
    getTemplate: function() {
        $('#common-weixin-echart-tmpl-src').template('common-weixin-echart-tmpl');
        return 'common-weixin-echart-tmpl';
    },
...
W.registerUIRole('div[data-ui-role="weixinEchart"]', function() {
    var $div = $(this);
    $div.removeData('view');
    ...
    var echart = new W.view.common.WeixinECharts({
        el: $div.get(0),
        app: app,
        api: api,
        resource: resource,
