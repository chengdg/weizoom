...
W.view.common.ECharts = Backbone.View.extend({
    getTemplate:function() {
        $('#stats-manage-summary-echart-tmpl-src').template('stats-manage-summary-echart-tmpl');
        return 'stats-manage-summary-echart-tmpl';
    },
...
W.registerUIRole('div[data-ui-role="manage-summary-echart"]', function() {
        var $div = $(this);
        $div.removeData('view');
