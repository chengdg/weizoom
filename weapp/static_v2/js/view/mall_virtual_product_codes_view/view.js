...
W.view.mall.VirtualProductCodeView = Backbone.View.extend({
	...
	render: function() {
		this.filterView = new W.view.mall.VirtualProductCodeFilterView({
			el: '.xa-virtualProductCodesFilterView',
