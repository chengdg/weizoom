...
W.view.common.ManageSaleECharts = Backbone.View.extend({
    getTemplate:function() {
        $('#stats-manage-flow-echart-tmpl-src').template('stats-manage-flow-echart-tmpl');
        return 'stats-manage-flow-echart-tmpl';
    },
...
W.registerUIRole('div[data-ui-role="manage-flow-echart"]', function() {
        var $div = $(this);
        $div.removeData('view');
