...
W.view.common.RedImageView = Backbone.View.extend({
    el: '',
    ...
    getTemplate: function() {
        $('#red-image-view-tmpl-src').template('red-image-view-tmpl');
        return 'red-image-view-tmpl';
    },
    ...
    render: function() {
        ...
        this.$el.find('.uploadify-button').prev().attr({
            height: 30,
            width: 90
        });
...
W.registerUIRole('input[data-ui-role="image-selector"]', function() {
    ...
    var $imageView = $imageInput.siblings('div[data-ui-role="red-image-selector-view"]').eq(0);
    ...
    var view = new W.view.common.RedImageView({
        el: $imageView.get(),
        picUrl: url,
        height: height,
        width: width,
