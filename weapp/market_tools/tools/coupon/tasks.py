...
@task
def send_message_to_member(rule, member_id, remark_text=None):
    #给用户发优惠券提示
    try:
        model_data = {
        ...
        template_message_api.send_weixin_template_message(rule.owner_id, member_id, model_data, template_message_model.COUPON_ARRIVAL_NOTIFY, remark_text)
    except:
