...
#IT 优惠券到账通知 orderTicketStore: coupon_store, orderTicketRule: coupon_rule 
...
template_message_dict = [[1, u'TM00247-购买成功通知' ,'product:product_name,price:final_price,time:payment_time', PAY_ORDER_SUCCESS], 
						...
						[0,  u'TM00851-优惠券到账通知' ,'orderTicketStore:coupon_store,orderTicketRule:coupon_rule', COUPON_ARRIVAL_NOTIFY],
