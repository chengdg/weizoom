...
class Command(BaseCommand):
	...
	def handle(self, **options):
		...
		module_list = ['lottery', 'survey', 'event', 'vote', 'sign','red_envelope', 'powerme','exsurvey', 'red_packet', 'group', 'shvote', 'rebate', 'evaluate', 'exlottery', 'exsign', 'egg', 'scratch', 'scanlottery']
