...
orders = requests.post("http://red.weapp.weizzz.com/openapi/order_list",data={"access_token": "WZT10_ff3fdc78a066b087044396990ce2c3a0",'order_status':3,'cur_page':1},headers=headers)
