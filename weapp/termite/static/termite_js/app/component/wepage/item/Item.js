/**
 * @class W.component.wepage.Item
 * 
 */
ensureNS('W.component.wepage');
W.component.wepage.Item = W.component.Component.extend({
    type: 'wepage.item',
    selectable: 'no',
    ...
    properties: [{
        ...
        fields: [{
            ...
            displayName: '',
            isUserProperty: true,
            dialogParameter: 'W.component.wepage.Item.getTarget',
...
W.component.wepage.Item.getTarget = function(component, $button) {
