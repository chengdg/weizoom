 ...
 * @class
 */
W.mobile.CoverManager = Backbone.View.extend({
    events: {
    ...
    initialize: function(options) {
        ...
        W.ParentBroadcaster.on('component:resize', this.onResizeComponent, this);
    }, 
    ...
    refresh: function() {
        ...
        var isCoverDisplayed = (parseInt(coveredCid) !== -1);
    ...
    getInsertIndicatorLayout: function() {
        ...
        xlog(this.$insertIndicator.parents('[data-component-container="true"]'));
    ...
    onBeforeReload: function() {
        ...
        W.ParentBroadcaster.off('component:resize', this.onResizeComponent, this);
