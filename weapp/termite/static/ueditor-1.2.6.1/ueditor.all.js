    ...
    Popup.prototype = {
        ...
        showAnchorRect: function ( rect, hoz, adj ){
            ...
            if(this.editor){
                ...
                baidu.editor.ui.uiUtils.getFixedLayer().style.zIndex = popEl.style.zIndex - 1 + 50;
            }
...
//            }
        ...
        _show: function (){
            if (this._hidden) {
                ...
                this._hidden = false;
                this.fireEvent('show');
                baidu.editor.ui.uiUtils.getFixedLayer().style.zIndex = this.getDom().style.zIndex - 4 + 50;
            }
        },
        isHidden: function (){
            return this._hidden;
