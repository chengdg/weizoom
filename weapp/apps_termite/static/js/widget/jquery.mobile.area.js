...
(function($, undefined) {
	...
	$.widget("mobile.area", $.mobile.widget, {
		...
		_create : function() {
            ...
            this.domList = {
                province: $('<select to-type="city" id="areaWidget-province">'+this._createDefaulteOption('province')+'</select>'),
                city: $('<select to-type="district" id="areaWidget-city">'+this._createDefaulteOption('city')+'</select>'),
                district: $('<select id="areaWidget-district">'+this._createDefaulteOption('district')+'</select>')
            }
