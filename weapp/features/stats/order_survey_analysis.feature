...
Background:
	...
	When 微信用户批量消费jobs的商品
		...
		| 2014-9-2   | tom      |    购买   | jobs      | 商品1,1   | 支付    | 微信支付       | 10      | 100      |          |        				| 110         |              				| 0      | 110    | 0    | jobs,发货         |  已发货         |
		| 2014-9-3   | marry    |    购买   | jobs      | 商品1,1   | 支付    | 货到付款       | 10      | 100      |          |       					| 110         |              				| 0      | 0      | 110  | jobs,支付         |  待发货         |
		| 2014-9-3   | tom1     |    购买   | jobs      | 商品1,1   | 未支付  | 货到付款       | 10      | 100      |          |       					| 0           |              				| 0      | 0      | 0    | jobs,取消         |  已取消         |
		| 2014-9-4   | bill     |    购买   | jobs      | 商品1,1   | 支付    | 货到付款       | 10      | 100      |          |        				| 110         | 0000001,1234567     		| 0      | 0      | 0    | jobs,支付         |  待发货         |
		| 2014-9-4   | marry    |    购买   | jobs      | 商品1,1   | 支付    | 支付宝         | 10      | 100      | 200      |        				| 90          |              				| 90     | 0      | 0    | jobs,发货         |  已发货         |
		| 2014-9-5   | bill     |    购买   | jobs      | 商品1,2   | 支付    | 微信支付       | 10      | 100      |          | 全体券1,coupon1_id_1   | 200         |              				| 0      | 200    | 0    | jobs,支付         |  待发货         |
		| 2014-9-5   | marry    |    购买   | jobs      | 商品1,1   | 支付    | 微信支付       | 10      | 100      | 200      |        				| 90          | 0000002,1234567 			| 0      | 0      | 0    | jobs,退款         |  退款中         |
		| 2014-9-6   | tom      |    购买   | jobs      | 商品1,1   | 支付    | 支付宝         | 10      | 100      |          | 全体券1,coupon1_id_2	| 100         | 0000003,1234567			  	| 0      | 0      | 0    | jobs,完成         |  已完成         |
		| 2014-9-7   | tom1     |    购买   | jobs      | 商品2,1   | 支付    | 微信支付       | 15      | 100      | 200      |        				| 95          | 0000004,1234567 			| 0      | 0      | 0    | jobs,完成         |  已完成         |
		| 2014-9-8   | tom2     |    购买   | jobs      | 商品1,1   | 支付    | 支付宝         | 10      | 100      |          | 全体券1,coupon1_id_3	| 100         | 0000005,1234567				| 20     | 0      | 0    | jobs,完成         |  已完成         |
		| 2014-9-9   | tom3     |    购买   | jobs      | 商品2,1   | 支付    | 微信支付       | 15      | 100      | 200      |        				| 95          | 0000006,1234567				| 0      | 45     | 0    | jobs,完成         |  已完成         |
		| 2014-9-10  | -tom4    |    购买   | jobs      | 商品2,1   | 支付    | 货到付款       | 15      | 100      |          |        				| 115         | 0000007,1234567				| 0      | 0      | 65   | jobs,完成         |  已完成         |
		...
		| 今天       | tom      |    购买   | jobs      | 商品2,1   | 支付    | 支付宝         | 15      | 100      | 200      |       					| 95          |              				| 95     | 0      | 0    | jobs,发货   	 	 |  已发货         |

@stats @stats.order_survey
...
@ignore
Scenario: 4 订单概况数据，筛选日期，默认筛选日期当天；快速查询；重置
...
@stats @wip.order_survey
Scenario: 5 订单概况数据,补充复购率对买家为‘未知’的订单的统计错误
