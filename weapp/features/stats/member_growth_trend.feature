	...
	二、会员增长趋势
		...
		1、【新增会员】：在查询区间的不同日期点的新增会员数量的分布曲线
			...
			例如：筛选日期：2015-5-1到2015-5-22
					2015-5-10的【新增会员】=∑会员.个数[(2015-5-10 00:00 <= 会员.加入时间 < 2015-5-11 00:00)]
					其他日期点的【新增会员】依次类推
		...
		2、【手机绑定会员】：在查询区间的不同日期点的新增手机绑定会员数量的分布曲线
			...
			例如：筛选日期：2015-5-1到2015-5-22
					2015-5-10的【手机绑定会员】=∑会员.个数[(2015-5-10 00:00 <= 会员.手机绑定时间 < 2015-5-11 00:00)]
					其他日期点的【手机绑定会员】依次类推
		...
		3、【下单会员】：在查询区间的不同日期点的下单会员的数量分布曲线
			...
			例如：筛选日期：2015-5-1到2015-5-22
					2015-5-10的【下单会员】=∑订单.买家个数[(2015-5-10 00:00 <= 订单.下单时间 < 2015-5-11 00:00)
...
Background:
	...
	| 2015-05-01 | bill2     | 购买 | jobs      | 商品1,1  | 支付    |   微信支付     | 10      | 100      | 10       | 0      | 100         | 0            | 0      |   100  | 0    |           |    已完成       |
	| 2015-05-03 | bill1     | 购买 | jobs      | 商品1,1  |         |   支付宝       | 10      | 100      |  0       | 0      |  0          | 0            | 0      |    0   | 0    |           |    已完成       |
	| 2015-05-03 | bill4     | 购买 | jobs      | 商品2,1  | 支付    |   微信支付     | 15      | 100      |  0       | 0      | 115         | 0            | 0      |    115 | 0    | jobs,取消 |    已取消       |
	| 2015-05-04 | bill1     | 测试 | jobs      | 商品1,1  | 支付    |   货到付款     | 10      | 100      |  0       | 30     | 80          | 0            | 0      |    0   | 80   | jobs,取消 |    已取消       |
	| 2015-05-05 | bill5     | 购买 | jobs      | 商品1,1  | 支付    |   货到付款     | 10      | 100      |  20      | 0      | 90          | 0            | 0      |    0   | 90   |           |    已发货       |
	| 2015-05-05 | bill5     | 购买 | jobs      | 商品2,1  | 支付    |   货到付款     | 10      | 100      |  20      | 0      | 90          | 0            | 0      |    0   | 90   |           |    已发货       |
	| 2015-05-06 | bill6     | 购买 | jobs      | 商品1,1  | 支付    |   支付宝       | 10      | 100      |  0       | 0      | 110         | 0            | 110    |    0   | 0    |           |    已完成       |
	| 2015-05-06 | bill3     | 购买 | jobs      | 商品1,1  | 支付    |   支付宝       | 10      | 100      |  0       | 0      | 110         | 0            | 110    |    0   | 0    |           |    已完成       |
	| 2015-05-06 | bill4     | 购买 | jobs      | 商品1,1  | 支付    |   支付宝       | 10      | 100      |  0       | 0      | 110         | 0            | 110    |    0   | 0    |           |    已完成       |
	| 2015-05-07 | bill7     | 测试 | jobs      | 商品2,1  | 支付    |   微信支付     | 15      | 100      |  0       | 0      | 115         | 0            | 0      |   115  | 0    |           |    已发货       |
	| 2015-06-01 | bill15    | 购买 | jobs      | 商品2,2  | 支付    |   支付宝       | 15      | 100      |  0       | 20     | 195         | 0            | 195    |    0   | 0    |           |    已发货       |
