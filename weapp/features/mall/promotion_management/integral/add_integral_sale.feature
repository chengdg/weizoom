...
Scenario:10 创建多商品的积分应用活动
	...
	When jobs创建积分应用活动
		...
		[{
			...
			"start_date": "今天",
			"end_date": "10天后",
			"product_name": "商品1,商品2,商品3,商品4,商品6",
			"is_permanant_active": false,
			"rules": 
				[{
					"member_grade": "全部",
	...
	Then jobs获取积分应用活动列表
		...
		[{
			"name":"多商品积分应用2",
			"product_name": "商品1,商品2,商品6",
			"product_price":"100.00,100.00 ~ 200.00,10.00",
			"discount":"25.0%~100.0%",
			...
			"name":"多商品积分应用1",
			"product_name": "商品1,商品2,商品3,商品4,商品6",
			"product_price":"100.00,100.00 ~ 200.00,100.00,100.00,10.00",
			"discount": "50.0%",
			"discount_money": 5.00,
			"status":"进行中"
		}]
