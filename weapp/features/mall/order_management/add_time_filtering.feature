...
Scenario: 1 选择时间段查询订单
	...
	When 微信用户批量消费jobs的商品
		...
		|  000002  | 3天前 |    今天      | bill     | 商品3,1        |   支付    |  支付宝    |  100   |          |                     |              |    100      |jobs,发货     |   已发货      |       今天    |
		|  000003  | 2天前 |    2天前     | bill     | 商品2,1        |   支付    |  支付宝    |  100   |          |                     |              |    110      |jobs,完成     |   已完成      |       1天前   |
		|  000004  | 2天前 |    2天前     | bill     | 商品2,1        |   支付    |  支付宝    |  100   |          | 优惠券,coupon1_id_1 |              |    10       |jobs,完成     |   已完成      |       2天前   |
		...
		|  000008  | 今天  |    今天      | bill     | 商品2,1        |   支付    |  支付宝    |  100   |          | 优惠券,coupon1_id_2 |              |     10      |jobs,退款     |   退款中      |       今天    |
		|  000009  | 今天  |              | bill     | 商品3,1        |           |  微信支付  |  100   |   100    |                     |              |     50      |              |   待支付      |               |
		|  000010  | 今天  |    今天      | bill     | 商品3,1        |   支付    |  微信支付  |  100   |          |                     |              |   100       |jobs,完成退款 |   退款成功    |       今天    |
		|  000011  | 今天  |    今天      | bill     | 商品3,1        |   支付    |  货到付款  |  100   |          |                     |              |     50      |jobs,取消     |   已取消      |               |
		|  000012  | 今天  |    今天      | bill     | 商品3,1        |           |  微信支付  |  100   |          | 优惠券,coupon1_id_3 |              |    0        |jobs,取消     |   已取消      |       今天    |
		|  000013  | 今天  |    今天      | bill     | 商品1,红色 S,1 |   支付    |  货到付款  |  100   |          |                     | 0000001,1    |     10      |jobs,取消     |   已取消      |               |
