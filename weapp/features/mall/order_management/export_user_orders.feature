...
Scenario: 3 导出订单信息中'总计'信息的校验
	...
	When 微信用户批量消费jobs的商品
		...
		|  000002  | 今天  |    今天      | bill     | 购买 |   jobs      | 商品3,1        |   支付    |  支付宝   |      100      |          |              |              |    100      |jobs,发货     |    已发货         |
		|  000003  | 2天前 |    2天前     | bill     | 购买 |   jobs      | 商品2,1        |   支付    |  支付宝   |      100      |          |              |              |    110      |jobs,完成     |    已完成         |
		|  000004  | 2天前 |    2天前     | bill     | 购买 |   jobs      | 商品2,1        |   支付    |  支付宝   |      100      |          | coupon2_id_1 |              |    10       |jobs,完成     |    已完成         |
		|  000005  | 1天前 |    1天前     | bill     | 购买 |   jobs      | 商品2,2        |   支付    | 货到付款  |      200      |          |              |              |    210      |              |    待发货         |
		|  000006  | 今天  |    今天      | bill     | 购买 |   jobs      | 商品3,1        |   支付    |  微信支付 |      100      |   100    |              |              |     50      |              |    待发货         |
		|  000007  | 今天  |    今天      | bill     | 购买 |   jobs      | 商品3,1        |   支付    |  支付宝   |      100      |          |              | 0000002,1    |     50      |jobs,完成     |    已完成         |
		|  000008  | 今天  |    今天      | bill     | 购买 |   jobs      | 商品2,1        |   支付    |  支付宝   |      100      |          | coupon1_id_1 |              |     10      |jobs,退款     |    退款中         |
		|  000009  | 今天  |              | bill     | 购买 |   jobs      | 商品3,1        |           |  微信支付 |      100      |   100    |              |              |     50      |              |    待支付         |
		|  000010  | 今天  |    今天      | bill     | 购买 |   jobs      | 商品3,1        |   支付    |  微信支付 |      100      |          |              |              |   100       |jobs,完成退款 |    退款成功       |
		|  000011  | 今天  |    今天      | bill     | 购买 |   jobs      | 商品3,1        |   支付    |  微信支付 |      100      |          |              |              |     50      |jobs,取消     |    已取消         |
		|  000012  | 今天  |    今天      | bill     | 购买 |   jobs      | 商品3,1        |           |  微信支付 |      100      |          | coupon2_id_2 |              |    0        |jobs,取消     |    已取消         |
		|  000013  | 今天  |    今天      | bill     | 购买 |   jobs      | 商品1,红色 S,1 |   支付    |  支付宝   |      100      |          |              | 0000001,1    |     10      |jobs,取消     |    已取消         |
	#导出所有订单
