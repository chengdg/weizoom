...
@supplier @order @mall2 @zhaoleilei
Scenario: 1 不同供货商订单导出
	...
	When jobs修改订单'0000009'的价格
		...
		"""
	Then jobs导出订单获取订单信息
	| order_no           | edit_money | sources |  order_time | pay_time | member | product_name | purchase_price | product_unit_price | count | purchase_costs | sales_money | money_total | integral | coupon_money | coupon_name | money_wcard | money |  status   | logistics |   number  | delivery_time |
	| 0000009-100        |    10.0    | 土小宝  |     今天    |          |  bill  |    商品3     |                |        100.0       |   1   |                |    100.0    |     0.0     |          |              |             |             |  0.0  |  待支付   |           |           |               |
	| 0000009-100        |    10.0    | 土小宝  |     今天    |          |  bill  |    商品5     |                |        100.0       |   1   |                |    100.0    |             |          |              |             |             |       |  待支付   |           |           |               |
	| 0000008-丹江湖-100 |   -10.0    | 丹江湖  |     今天    |          |  bill  |    商品4     |                |        100.0       |   1   |                |    100.0    |     0.0     |          |              |             |             |  0.0  |  待支付   |           |           |               |
	| 0000008-土小宝-100 |   -10.0    | 土小宝  |     今天    |          |  bill  |    商品5     |                |        100.0       |   1   |                |    100.0    |             |          |              |             |             |       |  待支付   |           |           |               |
