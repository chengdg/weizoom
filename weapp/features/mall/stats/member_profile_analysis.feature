...
Background:
	...
	| 昨天 | bill1    | 购买 | jobs      | 商品1,1  | 支付    |   微信支付     | 10      | 100      |  0       |        | 100         | 0            | 0      |   100  | 0    |           |    已完成       |
	| 今天 | bill3    | 购买 | jobs      | 商品1,1  |         |   支付宝       | 10      | 100      |  0       |        |  0          | 0            | 0      |    0   | 0    |           |    未支付       |
	| 今天 | bill4    | 购买 | jobs      | 商品2,1  | 支付    |   微信支付     | 15      | 100      |  0       |        | 115         | 0            | 0      |    115 | 0    | jobs,取消 |    已取消       |
	| 今天 | bill1    | 测试 | jobs      | 商品1,1  | 支付    |   货到付款     | 10      | 100      |  0       |        | 80          | 0            | 0      |    0   | 80   | jobs,取消 |    已取消       |
	| 今天 | bill1    | 购买 | jobs      | 商品1,1  | 支付    |   货到付款     | 10      | 100      |   0      |        | 90          | 0            | 0      |    0   | 90   |           |    已发货       |
	| 今天 | bill2    | 购买 | jobs      | 商品1,1  | 支付    |   支付宝       | 10      | 100      |  0       |        | 110         | 0            | 110    |    0   | 0    |           |    已完成       |
	| 今天 | bill1    | 测试 | jobs      | 商品2,1  | 支付    |   微信支付     | 15      | 100      |  0       |        | 115         | 0            | 0      |   115  | 0    |           |    已发货       |
	| 今天 | bill5    | 购买 | jobs      | 商品2,2  | 支付    |   支付宝       | 15      | 100      |  0       |        | 195         | 0            | 195    |    0   | 0    |           |    已发货       |
