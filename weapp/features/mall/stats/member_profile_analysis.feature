...
Background:
	...
	When 微信用户批量消费jobs的商品
		| order_id | date | consumer | product  | payment | pay_type | postage*   | price*      | paid_amount*   | alipay*   .00| wechat*| cash*   |    action     |  order_status*  |
		|  0001    | 昨天 | bill1    | 商品1,1  | 支付    | 微信支付 | 10.00      | 100.00      | 110.00         | 0.00      |  110.00   | 0.00    | jobs,完成     |    已完成       |
		|  0002    | 今天 | bill3    | 商品1,1  |         | 支付宝   | 10.00      | 100.00      | 110.00         | 0.00      |    0.00   | 0.00    |               |    待支付       |
		|  0003    | 今天 | bill1    | 商品2,1  |         | 微信支付 | 15.00      | 100.00      | 115.00         | 0.00      |    0.00   | 0.00    | jobs,取消     |    已取消       |
		|  0004    | 今天 | bill4    | 商品1,1  | 支付    | 货到付款 | 10.00      | 100.00      | 110.00         | 0.00      |    0.00   | 110.00  | jobs,发货     |    已发货       |
		|  0005    | 今天 | bill1    | 商品1,1  | 支付    | 微信支付 | 10.00      | 100.00      | 110.00         | 0.00      |    0.00   | 0.00    | jobs,退款     |    退款中       |
		|  0006    | 今天 | bill2    | 商品1,1  | 支付    | 支付宝   | 10.00      | 100.00      | 110.00         | 0.00      |    0.00   | 0.00    | jobs,完成退款 |    退款成功     |
		|  0007    | 今天 | bill1    | 商品2,1  | 支付    | 微信支付 | 15.00      | 100.00      | 115.00         | 0.00      |   115.00  | 0.00    | jobs,完成     |    已完成       |
		#|  0008    | 今天 | -lili    | 商品2,2  | 支付    | 支付宝   | 15.00      | 100.00      | 215.00         | 215.00    |    0.00   | 0.00    | jobs,发货     |    已发货       |
