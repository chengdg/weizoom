...
Background:
	...
	| 2015-05-01 | bill2     | 购买 | jobs      | 商品1,1  | 支付    |   微信支付     | 10      | 100      |  0       |        | 100         | 0            | 0      |   100  | 0    |           |    已完成       |
	| 2015-05-03 | bill1     | 购买 | jobs      | 商品1,1  |         |   支付宝       | 10      | 100      |  0       |        |  0          | 0            | 0      |    0   | 0    |           |    已完成       |
	| 2015-05-03 | bill4     | 购买 | jobs      | 商品2,1  | 支付    |   微信支付     | 15      | 100      |  0       |        | 115         | 0            | 0      |    115 | 0    | jobs,取消 |    已取消       |
	| 2015-05-04 | bill1     | 测试 | jobs      | 商品1,1  | 支付    |   货到付款     | 10      | 100      |  0       |        | 80          | 0            | 0      |    0   | 80   | jobs,取消 |    已取消       |
	| 2015-05-05 | bill5     | 购买 | jobs      | 商品1,1  | 支付    |   货到付款     | 10      | 100      |   0      |        | 90          | 0            | 0      |    0   | 90   |           |    已发货       |
	| 2015-05-05 | bill5     | 购买 | jobs      | 商品2,1  | 支付    |   货到付款     | 10      | 100      |   0      |        | 90          | 0            | 0      |    0   | 90   |           |    已发货       |
	| 2015-05-06 | bill6     | 购买 | jobs      | 商品1,1  | 支付    |   支付宝       | 10      | 100      |  0       |        | 110         | 0            | 110    |    0   | 0    |           |    已完成       |
	| 2015-05-06 | bill3     | 购买 | jobs      | 商品1,1  | 支付    |   支付宝       | 10      | 100      |  0       |        | 110         | 0            | 110    |    0   | 0    |           |    已完成       |
	| 2015-05-06 | bill4     | 购买 | jobs      | 商品1,1  | 支付    |   支付宝       | 10      | 100      |  0       |        | 110         | 0            | 110    |    0   | 0    |           |    已完成       |
	| 2015-05-07 | bill7     | 测试 | jobs      | 商品2,1  | 支付    |   微信支付     | 15      | 100      |  0       |        | 115         | 0            | 0      |   115  | 0    |           |    已发货       |
	| 2015-06-01 | bill15    | 购买 | jobs      | 商品2,2  | 支付    |   支付宝       | 15      | 100      |  0       |        | 195         | 0            | 195    |    0   | 0    |           |    已发货       |
