...
Background:
	...
	When 微信用户批量消费jobs的商品
		...
		|  0001    | 2015-05-01 | bill2     | 商品1,1  | 支付    | 微信支付 | 10      | 100      | 110         | 0      |   110  | 0    | jobs,完成     |    已完成       |
		|  0002    | 2015-05-03 | bill1     | 商品1,1  |         | 支付宝   | 10      | 100      | 110         | 0      |    0   | 0    |               |    待支付       |
		|  0003    | 2015-05-03 | bill4     | 商品2,1  |         | 微信支付 | 15      | 100      | 115         | 0      |    0   | 0    | jobs,取消     |    已取消       |
		|  0004    | 2015-05-04 | bill1     | 商品1,1  | 支付    | 货到付款 | 10      | 100      | 110         | 0      |    0   | 0    | jobs,取消     |    已取消       |
		|  0005    | 2015-05-05 | bill5     | 商品1,1  | 支付    | 货到付款 | 10      | 100      | 110         | 0      |    0   | 110  | jobs,发货     |    已发货       |
		|  0006    | 2015-05-05 | bill5     | 商品2,1  | 支付    | 货到付款 | 15      | 100      | 115         | 0      |    0   | 115  |               |    待发货       |
		|  0007    | 2015-05-06 | bill6     | 商品1,1  | 支付    | 支付宝   | 10      | 100      | 110         | 110    |    0   | 0    | jobs,完成     |    已完成       |
		|  0008    | 2015-05-06 | bill3     | 商品1,1  | 支付    | 支付宝   | 10      | 100      | 110         | 0      |    0   | 0    | jobs,退款     |    退款中       |
		|  0009    | 2015-05-06 | bill4     | 商品1,1  | 支付    | 支付宝   | 10      | 100      | 110         | 0      |    0   | 0    | jobs,完成退款 |    退款完成     |
