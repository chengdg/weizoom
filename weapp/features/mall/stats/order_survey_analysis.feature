...
Background:
    ...
    When 微信用户批量消费jobs的商品
        | order_id |   date   | consumer | product  | payment | pay_type | postage*| price* | integral | product_integral |       coupon         | paid_amount*| alipay*| wechat*| cash*|   action    | order_status*|
        |   0001   | 2014-8-5 | bill     | 商品1,1  | 支付    | 支付宝   | 10      | 100    |     0    |                  |                      | 110         | 110    | 0      | 0    |             | 待发货       |
        |   0002   | 2014-8-6 | tom      | 商品2,2  |         |          | 15      | 100    |     0    |                  |                      | 0           | 0      | 0      | 0    |  jobs,取消  | 已取消       |    
        |   0003   | 2014-9-1 | bill     | 商品2,2  | 支付    | 支付宝   | 15      | 100    |     0    |                  |                      | 215         | 215    | 0      | 0    |             | 待发货       |
        |   0004   | 2014-9-2 | tom      | 商品1,1  | 支付    | 微信支付 | 10      | 100    |     0    |                  |                      | 110         | 0      | 110    | 0    |  jobs,发货  | 已发货       |
        |   0005   | 2014-9-3 | marry    | 商品1,1  | 支付    | 货到付款 | 10      | 100    |     0    |                  |                      | 110         | 0      | 0      | 110  |             | 待发货       |
        |   0006   | 2014-9-3 | tom1     | 商品1,1  |         |          | 10      | 100    |     0    |                  |                      | 0           | 0      | 0      | 0    |  jobs,取消  | 已取消       |
        |   0007   | 2014-9-4 | bill     | 商品1,1  | 支付    | 货到付款 | 10      | 100    |     0    |                  |                      | 110         | 0      | 0      | 0    |             | 待发货       |
        |   0008   | 2014-9-4 | marry    | 商品1,1  | 支付    | 支付宝   | 10      | 100    |   200    | 200              |                      | 90          | 90     | 0      | 0    |  jobs,发货  | 已发货       |
        |   0009   | 2014-9-5 | bill     | 商品1,2  | 支付    | 微信支付 | 10      | 100    |     0    |                  | 全体券1,coupon1_id_1 | 200         | 0      | 200    | 0    |             | 待发货       |
        |   0010   | 2014-9-5 | marry    | 商品1,1  | 支付    | 微信支付 | 10      | 100    |   200    | 200              |                      | 90          | 0      | 0      | 0    |  jobs,退款  | 退款中       |
        |   0011   | 2014-9-6 | tom      | 商品1,1  | 支付    | 支付宝   | 10      | 100    |     0    |                  | 全体券1,coupon1_id_2 | 100         | 0      | 0      | 0    |  jobs,完成  | 已完成       |
        |   0012   | 2014-9-7 | tom1     | 商品2,1  | 支付    | 微信支付 | 15      | 100    |   200    | 200              |                      | 95          | 0      | 0      | 0    |  jobs,完成  | 已完成       |
        |   0013   | 2014-9-8 | tom2     | 商品1,1  | 支付    | 支付宝   | 10      | 100    |     0    |                  | 全体券1,coupon1_id_3 | 100         | 20     | 0      | 0    |  jobs,完成  | 已完成       |
        |   0014   | 2014-9-9 | tom3     | 商品2,1  | 支付    | 微信支付 | 15      | 100    |   200    | 200              |                      | 95          | 0      | 45     | 0    |  jobs,完成  | 已完成       |
        |   0015   | 2014-9-1 | -tom4    | 商品2,1  | 支付    | 货到付款 | 15      | 100    |     0    |                  |                      | 115         | 0      | 0      | 65   |  jobs,完成  | 已完成       |
        |   0016   | 2014-9-1 | -tom4    | 商品2,1  | 支付    | 微信支付 | 15      | 100    |     0    |                  |                      | 115         | 0      | 0      | 115  |jobs,完成退款| 退款成功     |
        |   0017   | 今天     | bill     | 商品2,1  |         |          | 15      | 100    |   200    | 200              |                      | 95          | 0      | 0      | 0    |             | 待支付       |
        |   0018   | 今天     | tom      | 商品2,1  | 支付    | 支付宝   | 15      | 100    |   200    | 200              |                      | 95          | 95     | 0      | 0    |  jobs,发货  | 已发货       |
