...
Background:
    ...
    When 微信用户批量消费jobs的商品
         ...
         |   0001   | 7天前  | bill     | 商品1,2 | 支付    | 支付宝   | 10.00      | 100.00      | 210.00         | 210.00    |    0.00   | 0.00    |  jobs,发货    |   已发货     |
         |   0002   | 6天前  | tom      | 商品1,1 | 支付    | 微信支付 | 10.00      | 100.00      | 110.00         | 0.00      |    110.00 | 0.00    |  jobs,完成    |   已完成     |
         |   0003   | 5天前  | -tom     | 商品1,1 | 支付    | 货到付款 | 10.00      | 100.00      | 110.00         | 0.00      |    0.00   | 110.00  |               |   待发货     |
         |   0004   | 5天前  | -tom1    | 商品2,5 | 支付    | 支付宝   | 15.00      | 100.00      | 515.00         | 515.00    |    0.00   | 0.00    |               |   待发货     |
         |   0005   | 5天前  | -tom1    | 商品2,1 | 支付    | 支付宝   | 15.00      | 100.00      | 115.00         | 115.00    |    0.00   | 0.00    |               |   待发货     |
         |   0006   | 4天前  | -tom1    | 商品3,1 | 支付    | 支付宝   | 20.00      | 100.00      | 120.00         | 120.00    |    0.00   | 0.00    |               |   待发货     |
         |   0007   | 4天前  | -tom2    | 商品1,4 | 支付    | 微信支付 | 10.00      | 100.00      | 410.00         | 0.00      |    410.00 | 0.00    |               |   待发货     |
         |   0008   | 4天前  | bill     | 商品2,9 | 支付    | 支付宝   | 15.00      | 100.00      | 915.00         | 915.00    |    0.00   | 0.00    |  jobs,发货    |   已发货     |
         |   0009   | 1天前  | bill     | 商品3,1 | 支付    | 支付宝   | 20.00      | 100.00      | 120.00         | 120.00    |    0.00   | 0.00   | jobs,完成退款 |   退款成功   |
         |   0010   | 今天   | bill     | 商品1,2 |         | 支付宝   | 10.00      | 100.00      | 210.00         | 0.00      |    0.00   | 0.00    |               |   待支付     |
         |   0011   | 今天   | bill     | 商品2,3 |         | 微信支付 | 15.00      | 100.00      | 315.00         | 0.00      |    0.00   | 0.00    | jobs,取消     |   已取消     |
         |   0012   | 今天   | tom      | 商品1,4 | 支付    | 微信支付 | 10.00      | 100.00      | 410.00         | 0.00      |    0.00   | 0.00    | jobs,退款     |   退款中     |
