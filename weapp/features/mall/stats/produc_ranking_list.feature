...
Background:
    ...
    When 微信用户批量消费jobs的商品
         | order_id |  date  | consumer |businessman| product | payment | pay_type | postage*| price*   | paid_amount*| alipay*| wechat*| cash*|    action     | order_status*|
         |   0001   | 7天前  | bill     | jobs      | 商品1,2 | 支付    | 支付宝   | 10      | 100      | 210         | 210    |    0   | 0    |  jobs,发货    |   已发货     |            
         |   0002   | 6天前  | tom      | jobs      | 商品1,1 | 支付    | 微信支付 | 10      | 100      | 110         | 0      |    110 | 0    |  jobs,完成    |   已完成     |           
         |   0003   | 5天前  | -tom     | jobs      | 商品1,1 | 支付    | 货到付款 | 10      | 100      | 110         | 0      |    0   | 110  |               |   待发货     |
         |   0004   | 5天前  | -tom1    | jobs      | 商品2,5 | 支付    | 支付宝   | 15      | 100      | 515         | 515    |    0   | 0    |               |   待发货     |
         |   0005   | 5天前  | -tom1    | jobs      | 商品2,1 | 支付    | 支付宝   | 15      | 100      | 115         | 115    |    0   | 0    |               |   待发货     |
         |   0006   | 4天前  | -tom1    | jobs      | 商品3,1 | 支付    | 支付宝   | 20      | 100      | 120         | 120    |    0   | 0    |               |   待发货     |
         |   0007   | 4天前  | -tom2    | jobs      | 商品1,4 | 支付    | 微信支付 | 10      | 100      | 410         | 0      |    410 | 0    |               |   待发货     |
         |   0008   | 4天前  | bill     | jobs      | 商品2,9 | 支付    | 支付宝   | 15      | 100      | 915         | 915    |    0   | 0    |  jobs,发货    |   已发货     |
         |   0009   | 1天前  | bill     | jobs      | 商品3,1 | 支付    | 支付宝   | 20      | 100      | 120         | 120    |    0   | 0    | jobs,完成退款 |   退款成功   |
         |   0010   | 今天   | bill     | jobs      | 商品1,2 |         | 支付宝   | 10      | 100      | 210         | 0      |    0   | 0    |               |   待支付     |       
         |   0011   | 今天   | bill     | jobs      | 商品2,3 |         | 微信支付 | 15      | 100      | 315         | 0      |    0   | 0    | jobs,取消     |   已取消     |
         |   0012   | 今天   | tom      | jobs      | 商品1,4 | 支付    | 微信支付 | 10      | 100      | 410         | 0      |    0   | 0    | jobs,退款     |   退款中     |
