...
Scenario:1  经营概况：销售额和成交订单
	...
	When 微信用户批量消费jobs的商品
		...
		|   001    | 2015-04-04 | mary     | 商品1,1 | 支付    | 微信支付 | 10.00       |  100.00   | 110.00          | jobs,完成    |    已完成     |
		|   002    | 2015-05-02 | bill     | 商品1,1 |         | 支付宝   | 10.00       |  100.00   | 110.00          | jobs,取消    |    已取消     |
		|   003    | 2015-05-03 | tom      | 商品2,1 | 支付    | 微信支付 | 15.00       |  100.00   | 115.00          | jobs,完成    |    已完成     |
		|   004    | 2015-05-05 | bill     | 商品1,1 | 支付    | 货到付款 | 10.00       |  100.00   | 110.00          |              |    待发货     |
		|   005    | 2015-05-06 | tom      | 商品1,1 | 支付    | 货到付款 | 10.00       |  100.00   | 110.00          | jobs,发货    |    已发货     |
		|   006    | 2015-05-06 | bill     | 商品1,1 | 支付    | 支付宝   | 10.00       |  100.00   | 110.00          | jobs,退款    |    退款中     |
		|   007    | 2015-05-08 | bill     | 商品2,1 | 支付    | 微信支付 | 15.00       |  100.00   | 115.00          | jobs,完成退款|    退款成功   |
		|   008    | 2015-05-10 | mary     | 商品2,2 | 支付    | 支付宝   | 15.00       |  100.00   | 215.00          | jobs,发货    |    已发货     |
		|   009    | 2015-05-10 | tom      | 商品2,2 | 支付    | 支付宝   | 15.00       |  100.00   | 215.00          | jobs,发货    |    已发货     |
		|   010    | 今天       | mary     | 商品2,2 |         | 支付宝   | 15.00       |  100.00   | 215.00          |              |    待支付     |
		|   011    | 今天       | -duhao   | 商品2,5 |         | 支付宝   | 15.00       |  100.00   | 515.00          |              |    待支付     |
		|   012    | 今天       | zhangsan | 商品2,5 |         | 支付宝   | 15.00       |  100.00   | 515.00          |              |    待支付     |
