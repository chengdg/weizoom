...
Scenario:1  经营概况：销售额和成交订单
	...
	When 微信用户批量消费jobs的商品
		| order_id |   date     | consumer |businessman| product | payment | payment_method | postage* | price* | paid_amount* | action       | order_status* |
		|   001    | 2015-04-04 | mary     | jobs      | 商品1,1 | 支付    |   微信支付     | 10       |  100   | 100          | jobs,完成    |    已完成     |
		|   002    | 2015-05-02 | bill     | jobs      | 商品1,1 |         |   支付宝       | 10       |  100   | 110          | jobs,取消    |    已取消     |
		|   003    | 2015-05-03 | tom      | jobs      | 商品2,1 | 支付    |   微信支付     | 15       |  100   | 115          | jobs,完成    |    已完成     |
		|   004    | 2015-05-05 | bill     | jobs      | 商品1,1 | 支付    |   货到付款     | 10       |  100   | 110          |              |    待发货     |
		|   005    | 2015-05-06 | tom      | jobs      | 商品1,1 | 支付    |   货到付款     | 10       |  100   | 110          | jobs,发货    |    已发货     |
		|   006    | 2015-05-06 | bill     | jobs      | 商品1,1 | 支付    |   支付宝       | 10       |  100   | 110          | jobs,退款    |    退款中     |
		|   007    | 2015-05-08 | bill     | jobs      | 商品2,1 | 支付    |   微信支付     | 15       |  100   | 115          | jobs,完成退款|    退款成功   |
		|   008    | 2015-05-10 | mary     | jobs      | 商品2,2 | 支付    |   支付宝       | 15       |  100   | 215          | jobs,发货    |    已发货     |
		|   009    | 2015-05-10 | tom      | jobs      | 商品2,2 | 支付    |   支付宝       | 15       |  100   | 215          | jobs,发货    |    已发货     |
		|   010    | 今天       | mary     | jobs      | 商品2,2 |         |   支付宝       | 15       |  100   | 0            |              |    待支付     |
		|   011    | 今天       | -duhao   | jobs      | 商品2,5 |         |   支付宝       | 15       |  100   | 0            |              |    待支付     |
		|   012    | 今天       | zhangsan | jobs      | 商品2,5 |         |   支付宝       | 15       |  100   | 0            |              |    待支付     |
