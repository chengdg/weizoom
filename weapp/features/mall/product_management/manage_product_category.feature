...
@mall2 @product @group @ProductList  @mall.product_category @mall
Scenario:6 商品列表查看分组信息
	Given jobs登录系统
	Then jobs能获得'待售'商品列表
		|  name     |   categories     | price    |  stocks  |   operate                  |
		|  水晶虾仁 |                  |   3.00   |    3     |   上架，彻底删除，编辑分组 |
		|  叫花鸡   |      分类1       |   12.00  |    3     |   上架，彻底删除，编辑分组 |
		|  东坡肘子 |   分类1 更多(1)  |   11.12  |   无限   |   上架，彻底删除，编辑分组 |
	When jobs查看更多分组
	Then jobs能获得更多分组信息
		|  name     |   categories     | price    |  stocks  |   operate                  |
		|  东坡肘子 |   分类1,分类2    |   11.12  |   无限   |   上架，彻底删除，编辑分组 |
	When jobs批量上架商品
		"""
			["水晶虾仁"]
		"""
...
Scenario:7 在商品列表编辑分组信息
	...
	Then jobs能获得'待售'商品列表
		|  name     |   categories     | price    |  stocks  |   operate                  |
		|  水晶虾仁 |      分类1       |   3.00   |    3     |   上架，彻底删除，编辑分组 |
		|  叫花鸡   |      分类1       |   12.00  |    3     |   上架，彻底删除，编辑分组 |
		|  东坡肘子 |   分类1 更多(1)  |   11.12  |   无限   |   下架，彻底删除，编辑分组 |
	When jobs给商品'东坡肘子'删除商品分组
		"""
		{
			"name": "分类1"
		}
	...
	Then jobs能获得'待售'商品列表
		...
		|  水晶虾仁 |      分类1       |   3.00   |    3     |   上架，彻底删除，编辑分组 |
		|  叫花鸡   |      分类1       |   12.00  |    3     |   上架，彻底删除，编辑分组 |
		|  东坡肘子 |      分类2       |   11.12  |   无限   |   下架，彻底删除，编辑分组 |
	When jobs给商品'叫花鸡'删除商品分组
		"""
		{
			"name": "分类1"
		}
		"""
	And jobs给商品'叫花鸡'添加商品分组
		"""
		{
			"name": "分类2"
		}
