...
Background:
	...
	When 微信用户批量消费jobs的商品
		| date       | consumer | type      |businessman|   product | payment | payment_method | freight |   price  | paid_amount |  alipay | wechat | cash  |     action    |  order_status   |delivery_time|payment_time|
		| 2015-4-5   | bill     | 	 购买   | jobs      | 商品1,1   | 支付    | 支付宝         |  0      |   0.01   |    0.01     |  0.01   | 0      | 0     | jobs,完成     |  已完成         | 2015-4-5      |   2015-4-5 |
		| 2015-4-6   | bill     | 	 购买   | jobs      | 商品1,1   | 支付    | 微信支付       |  0      |   0.01   |    0.01     |  0      | 0.01   | 0     | jobs,发货     |  已发货         | 2015-4-6	     |  2015-4-6 |
		| 2015-4-7   | bill     | 	 购买   | jobs      | 商品1,1   | 支付    | 微信支付       |  0      |   0.01   |    0.01     |  0      | 0.01   | 0     | jobs,退款     |  退款中         | 2015-4-6      |  2015-4-6 |
		| 2015-4-7   | bill     | 	 购买   | jobs      | 商品1,1   | 支付    | 货到付款       |  0      |   0.01   |    0.01     |  0      | 0      | 0.01  | jobs,无操作   |  待发货         |               |  2015-4-7 |
		| 2015-7-3   | tom      | 	 购买   | jobs      | 商品3,1   | 支付    | 货到付款       |  0      |   1      |    1        |  0      | 0      | 0     | jobs,取消     |  已取消         |               |  2015-7-3 |
		| 2015-7-4   | tom      | 	 购买   | jobs      | 商品3,1   | 支付    | 支付宝         |  0      |   1      |    1        |  1      | 0      | 0     | jobs,发货     |  已发货         |    2015-07-03 |  2015-7-3|
		| 2015-7-1   | -tom2    | 	 购买   | jobs      | 商品1,1   | 支付    | 支付宝         |  0      |   0.01   |    0.01     |  0.01   | 0      | 0     | jobs,发货     |  已发货         |  2015-07-01   |  2015-7-1 |
		| 2015-7-10  | tom      | 	 购买   | jobs      | 商品3,1   |         | 微信支付       |  0      |   1      |    1        |  0      | 1      | 0     | jobs,无操作   |  待支付         |               |           |
		| 2015-07-02 | tom      | 	 购买   | jobs      | 商品3,1   | 未支付  | 微信支付       |  0      |   1      |    1        |  0      | 0      | 0     | jobs,完成退款 |  退款成功       |     2015-07-02 |  2015-7-2 |
