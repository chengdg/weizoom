	...
	2、系统中"有效商家"的"在售商品管理"中的[非多规格商品]商品列表：
		...
		(6)【操作】：{"放入待售","无更新","更新"}；"无更新"灰色字体,其他为蓝色字体
			1)商家商品有更新,商品池中的对应的该商品【商品信息】的商品标题显示"更新"标签；【状态】列变为"待更新"；【操作】列变为"更新"
				1> 判断更新时不识别以下字段：【店内分组】,【会员折扣】,【运费设置】,【支付方式】,【商品发票】,【总销量】,【库存】；
			...
			2)操作项
				1> "放入待售"：没有选择同步的商品；
					...
					同步商品的如下字段：除了【店内分组】,【会员折扣】,【运费设置】,【支付方式】,【商品发票】,【总销量】,【采购价】其他字段都同步
				2> "无更新"：已经选择同步到自营平台,并且没有更新的商品；此按钮不使能
				3> "更新"：已经选择同步到自营平台,并且有更新的商品；
					1)点击"更新"商品同步更新商品,商品此列表中此商品的【状态】字段变为"已选择",商品的【操作】字段变为"无更新"
					2)更新商品的字段如下：除了【店内分组】,【会员折扣】,【运费设置】,【支付方式】,【商品发票】,【总销量】,【库存】,【采购价】;不更新的字段保留修改值
...
Scenario:3 有效商家修改库存和商品名称,商品池中展示的商品变化
	#商家bill修改在售商品的库存
		Given bill登录系统
...
Scenario:4 自营平台同步商品池中的商品
	...
	#2 同步商品的如下字段：除了【店内分组】,【会员折扣】,【运费设置】,【支付方式】,【商品发票】,【总销量】,【采购价】其他字段都同步
