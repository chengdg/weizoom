...
Scenario:2 带参数返利活动[扫码后成交金额]-已关注会员可参与；首单；现金
	...
	When 微信用户批量消费jobs的商品
		...
		|   0001   | 2016-05-09       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00    | 1.00    |     1.00        |                | jobs,发货  |    已完成     |
		|   0002   | 2016-05-09       |   tom    | 商品1,1 |   支付  |  支付宝   |   0.00    | 1.00    |     1.00        | 0000041,1234567| jobs,发货  |    已完成     |
		|   0003   | 2016-05-09       |  zhouxun | 商品1,1 |   支付  |  微众卡   |   0.00    | 1.00    |     1.00        |                | jobs,发货  |    已完成     |    
...
Scenario:3 带参数返利活动[扫码后成交金额]-已关注会员可参与；首单；非现金
	...
	When 微信用户批量消费jobs的商品
		| order_id | date             | consumer | product | payment | pay_type  |postage*   |price*   | paid_amount*    | weizoom_card   | action     | order_status  |
		|   0001   | 2016-05-04       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00    | 1.00    |     1.00        |                | jobs,发货  |    已完成     |
		|   0002   | 2016-05-09       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00    | 1.00    |     1.00        |                | jobs,发货  |    已完成     |
		|   0003   | 2016-05-10       |   tom    | 商品1,1 |   支付  |  支付宝   |   0.00    | 1.00    |     1.00        | 0000041,1234567| jobs,发货  |    已完成     |
		|   0004   | 2016-05-12       |  zhouxun | 商品1,1 |   支付  |  微众卡   |   0.00    | 1.00    |     1.00        |                | jobs,发货  |    已完成     |
...
Scenario:4 带参数返利活动[扫码后成交金额]-已关注会员可参与；不限；现金
	...
	When 微信用户批量消费jobs的商品
		| order_id | date             | consumer | product | payment | pay_type  |postage*   |price*   | paid_amount*    | weizoom_card   | action     | order_status  |
		|   0001   | 2016-05-10       |   tom    | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0002   | 2016-05-10       |   tom    | 商品2,1 |   支付  |  支付宝   |   0.00   | 0.50   |     0.50       |                | jobs,发货  |    已完成     |
		|   0003   | 2016-05-10       |  zhouxun | 商品1,1 |   支付  |  微众卡   |   0.00   | 1.00   |     1.00       | 0000041,1234567| jobs,发货  |    已完成     |
...
Scenario:5 带参数返利活动[扫码后成交金额]-已关注会员可参与；不限；非现金
	...
	When 微信用户批量消费jobs的商品
		| order_id | date             | consumer | product | payment | pay_type  |postage*   |price*   | paid_amount*    | weizoom_card   | action     | order_status  |
		|   0001   | 2016-05-09       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0002   | 2016-05-10       |   tom    | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0003   | 2016-05-10       |   tom    | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0004   | 2016-05-10       |  zhouxun | 商品1,1 |   支付  |  微众卡   |   0.00   | 1.00   |     1.00       | 0000041,1234567| jobs,发货  |    已完成     |
...
Scenario:8 带参数返利活动[扫码后成交金额]-已关注会员不可参与；首单；现金
	...
	When 微信用户批量消费jobs的商品
		| order_id | date             | consumer | product | payment | pay_type  |postage*   |price*   | paid_amount*    | weizoom_card   | action     | order_status  |
		|   0001   | 2016-04-09       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00   | 0.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0002   | 2016-05-10       |   tom    | 商品1,1 |   支付  |  支付宝   |   0.00   | 0.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0003   | 2016-05-10       |   tom    | 商品1,1 |   支付  |  支付宝   |   0.00   | 0.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0004   | 2016-05-10       |  zhouxun | 商品1,1 |   支付  |  微众卡   |   0.00   | 0.00   |     1.00       | 0000041,1234567| jobs,发货  |    已完成     |
...
Scenario:9 带参数返利活动[扫码后成交金额]-已关注会员不可参与；首单；非现金
	...
	When 微信用户批量消费jobs的商品
		| order_id | date             | consumer | product | payment | pay_type  |postage*   |price*   | paid_amount*    | weizoom_card   | action     | order_status  |
		|   0001   | 2016-05-09       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0002   | 2016-05-10       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0003   | 2016-05-10       |   tom    | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0004   | 2016-05-10       |  zhouxun | 商品1,1 |   支付  |  微众卡   |   0.00   | 1.00   |     1.00       | 0000041,1234567| jobs,发货  |    已完成     |
...
Scenario:10 带参数返利活动-多个返利活动同时存在，并且同一个人扫多个返利活动的码且下单
	...
	When bill购买jobs的商品
		| order_id | date             | consumer | product | payment | pay_type  |postage*   |price*   | paid_amount*    | weizoom_card   | action     | order_status  |
		|   0001   | 2016-05-05       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
		|   0002   | 2016-05-08       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |
	...
	When bill购买jobs的商品
		| order_id | date             | consumer | product | payment | pay_type  |postage*   |price*   | paid_amount*    | weizoom_card   | action     | order_status  |
		|   0003   | 2016-05-09       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00   | 1.00   |     1.00       |                | jobs,发货  |    已完成     |	
...
Scenario:11 带参数返利活动-查看发放详情
	...
	When bill购买jobs的商品
		| order_id | date             | consumer | product | payment | pay_type  |postage*   |price*   | paid_amount*    | weizoom_card    | action     | order_status  |
		|   0001   | 2016-05-12       |   bill   | 商品1,1 |   支付  |  支付宝   |   0.00    | 1.00    |     1.00        | 0000003,1234567 | jobs,发货  |    已完成     |
