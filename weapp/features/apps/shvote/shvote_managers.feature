...
Scenario:4 没有有微信用户报名参与活动和有微信用户报名参与活动，但是均未通过审核
	#选手分组-无分组
	Given jobs登录系统
	When jobs审核不通过'bill'
	When bill关注jobs的公众号
...
Scenario:6 微信用户浏览高级投票活动主页
	...
	Then bill获得微信高级投票活动'微信高级投票-进行中'的内容
		"""
		{
			"total_parted":0,
			"total_counts":0,
