...
Background:
	...
	When 微信用户批量参加jobs的刮刮卡活动
		| name      |member_name| prize_grade | prize_name |lottery_time| receive_status |
		|刮刮卡刮奖01 |bill       | 一等奖       | 优惠券1     |前天      | 已领取         |
		|刮刮卡刮奖01 |bill       | 一等奖       | 优惠券1     |昨天      | 已领取         |
		|刮刮卡刮奖01 |tom        | 一等奖       | 优惠券1     |今天      | 已领取         |
		|刮刮卡刮奖01 |bill       | 一等奖       | 优惠券1     |今天      | 已领取         |
		|刮刮卡刮奖01 |tom1       | 一等奖       | 优惠券1     |今天      | 已领取         |

@mall2 @apps @apps_scratch @view_scratch_results
Scenario:1 查看结果列表
	Given jobs登录系统
	Then jobs获得刮刮卡活动列表
	"""
	...
	"""
	When jobs查看刮刮卡活动'刮刮卡刮奖01'
	Then jobs获得刮刮卡活动'刮刮卡刮奖01'的结果列表
...
Scenario:3 查看结果列表分页
	...
	And jobs设置分页查询参数
		...
		"""
	When jobs查看刮刮卡活动'刮刮卡刮奖01'
	#Then jobs获得刮刮卡活动'刮刮卡刮奖01'的结果列表共'3'页

	When jobs访问刮刮卡活动'刮刮卡刮奖01'的结果列表第'1'页
	Then jobs获得刮刮卡活动'刮刮卡刮奖01'的结果列表
		|member_name| prize_grade | prize_name |lottery_time| receive_status |
		|tom1       | 一等奖      | 优惠券1      |今天        | 已领取         |
		|bill       | 一等奖      | 优惠券1      |今天        | 已领取         |

	When jobs访问刮刮卡活动'刮刮卡刮奖01'的结果列表下一页
	Then jobs获得刮刮卡活动'刮刮卡刮奖01'的结果列表
		|member_name| prize_grade | prize_name |lottery_time| receive_status |
		|tom        | 一等奖      | 优惠券1    |今天        | 已领取         |
		|bill       | 一等奖      | 优惠券1    |昨天        | 已领取         |

	When jobs访问刮刮卡活动'刮刮卡刮奖01'的结果列表第'3'页
	Then jobs获得刮刮卡活动'刮刮卡刮奖01'的结果列表
		|member_name| prize_grade | prize_name |lottery_time| receive_status |
		|bill       | 一等奖      | 优惠券1      |前天        | 已领取         |

	When jobs访问刮刮卡活动'刮刮卡刮奖01'的结果列表上一页
	Then jobs获得刮刮卡活动'刮刮卡刮奖01'的结果列表
		|member_name	| prize_grade | prize_name |lottery_time| receive_status |
		|tom        | 一等奖      | 优惠券1    |今天        | 已领取         |
		|bill       | 一等奖      | 优惠券1    |昨天        | 已领取         |
