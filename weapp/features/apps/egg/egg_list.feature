...
@mall2 @apps @apps_egg @egg_list
Scenario:1 砸金蛋活动列表查询
	Given jobs登录系统
	#空查询
		When jobs设置砸金蛋活动列表查询条件
			"""
			{}
			"""
		Then jobs获得砸金蛋活动列表
...
Scenario:2 砸金蛋活动列表分页
	...
	And jobs设置分页查询参数
		...
		"""
		#Then jobs获得砸金蛋活动列表共'3'页

	When jobs访问砸金蛋活动列表第'1'页
	Then jobs获得砸金蛋活动列表
		"""
		[{
			"name":"砸金蛋抽奖03",
