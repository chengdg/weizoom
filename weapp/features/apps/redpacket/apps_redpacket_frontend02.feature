...
@mall2 @apps_redpacket @apps_redpackets_frontend @apps_redpackets_frontend02
...
Scenario:3 非会员通过会员分享的活动链接参加活动
	...
	Then tom获得jobs的拼红包活动'拼红包活动2'的内容
		"""
		[{
			"name":"拼红包活动2",
			"is_show_countdown":"false",
...
Scenario:6 会员参与'未开始'的拼红包活动
	...
	Then bill获得jobs的拼红包活动'未开始的红包活动'的内容
		"""
		[{
			"name":"未开始的红包活动",
			"is_show_countdown":"true",
...
Scenario:7 会员参与'已结束'的拼红包活动
	...
	Then tom获得jobs的拼红包活动'已结束的红包活动'的内容
		"""
		[{
			"name":"已结束的红包活动",
			"is_show_countdown":"false",
