...
Scenario:1 修改最高连续签到天数，当会员累计签到达到该天数，继续签到从头开始
	...
	"""
	When bill访问jobs的weapp
	Then bill在jobs的weapp中拥有6积分
	And bill能获得weapp优惠券列表
		"""
		[{
...
When jobs添加签到活动"签到活动2",并且保存
	...
	Then bill获得系统回复的消息
	"""
	签到成功！<br />已连续签到3天。<br />本次签到获得以下奖励：<br />10积分<br />优惠券2<br />签到说明：1签到赚积分！连续签到奖励更丰富哦！<br />每日签到获得2积分和优惠券1一张，连续签到3天获得10积分和优惠券2一张<br />
	"""
	When 修改bill的签到时间为前一天
	When 清空浏览器
	When bill在微信中向jobs的公众号发送消息"签到2"
