...
Scenario:1 选择当前页的部分会员，选择"给选中的人修改等级"
	...
	#选择第1页部分会员批量修改等级
		...
		Then jobs可以获得会员列表
			...
			| bill  |   普通会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-05    | 直接关注 |             |
			| tom   |   银牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-04    | 推广扫码 |             |
			| marry |   普通会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-03    | 会员分享 |             |
	...
	#选择第3页部分会员批量修改等级
		...
		Then jobs可以获得会员列表
			| name  | member_rank | friend_count | integral | pay_money | unit_price | pay_times | attention_time  |  source  |    tags     |
			| bill1 |   铜牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-06-06    | 直接关注 |             |
			| bill2 |   普通会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-06-05    | 推广扫码 |             |
...
Scenario:2 选择当前页的全部会员，选择"给选中的人修改等级"
	...
	#选择第1页全部会员批量修改等级
		...
		Then jobs可以获得会员列表
			| name  | member_rank | friend_count | integral | pay_money | unit_price | pay_times | attention_time  |  source  |    tags     |
			| bill  |   银牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-05    | 直接关注 |             |
			| tom   |   银牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-04    | 推广扫码 |             |
			| marry |   银牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-03    | 会员分享 |             |
	...
	#选择第2页全部会员批量修改等级
		...
		Then jobs可以获得会员列表
			| name  | member_rank | friend_count | integral | pay_money | unit_price | pay_times | attention_time  |  source  |    tags     |
			| tom1  |   金牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-02    | 会员分享 |             |
...
Scenario:4 选择当前页的部分会员，选择"给筛选出来的所有人修改等级"
	...
	#选择第1页部分会员批量修改等级
		...
		Then jobs可以获得会员列表
			| name  | member_rank | friend_count | integral | pay_money | unit_price | pay_times | attention_time  |  source  |    tags     |
			| marry |   银牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-03    | 会员分享 |             |
			| tom1  |   银牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-02    | 会员分享 |             |
			| tom2  |   银牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-01    | 会员分享 |             |
	...
	#选择第2页部分会员批量修改等级
		...
		Then jobs可以获得会员列表
			| name  | member_rank | friend_count | integral | pay_money | unit_price | pay_times | attention_time  |  source  |    tags     |
			| marry |   金牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-03    | 会员分享 |             |
			| tom1  |   金牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-02    | 会员分享 |             |
			| tom2  |   金牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-01    | 会员分享 |             |
...
Scenario:5 选择当前页的全部会员，选择"给筛选出来的所有人修改等级"
	...
	#选择第1页全部会员批量修改等级
		...
		Then jobs可以获得会员列表
			| name  | member_rank | friend_count | integral | pay_money | unit_price | pay_times | attention_time  |  source  |    tags     |
			| marry |   铜牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-03    | 会员分享 |             |
			| tom1  |   铜牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-02    | 会员分享 |             |
			| tom2  |   铜牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-01    | 会员分享 |             |
...
Scenario:7 批量修改会员等级后，在会员详情和会员的个人中心，会员等级都是修改后的等级，会员在购买有会员价商品时可以享受会员价
	...
	#批量修改会员等级，选择"给筛选出来的所有人修改等级"
		...
		#不选择任何会员，直接批量修改等级
			...
			Then jobs可以获得会员列表
				| name  | member_rank | friend_count | integral | pay_money | unit_price | pay_times | attention_time  |  source  |    tags     |
				| bill  |   铜牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-09-05    | 直接关注 |             |
				| bill1 |   铜牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-06-06    | 直接关注 |             |
				| bill3 |   铜牌会员  |       0      |     0    |   0.00    |    0.00    |      0    |   2014-06-04    | 直接关注 |             |
