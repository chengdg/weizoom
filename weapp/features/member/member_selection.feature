...
Scenario:1 默认条件和空条件查询
	...
	#首次进入，默认条件查询
		...
		Then jobs可以获得会员列表
			...
			| tom3  |   银牌会员  |       1      |    100   |   225.00  |    112.50  |      2    | 2014-08-05 | 会员分享 | 分组1,分组3 |
			| tom1  |   银牌会员  |       2      |     0    |   220.00  |    110.00  |      2    | 2014-08-04 | 直接关注 | 分组1       |
	...
	#空调条件查询，“重置”查询条件，空调间查询所有数据
		...
		Then jobs可以获得会员列表
			...
			| tom3  | 银牌会员    |       1      |    100   |   225.00  |    112.50  |    2      | 2014-08-05 | 会员分享 | 分组1,分组3 |
			| tom2  | 金牌会员    |       0      |     50   |   110.00  |    110.00  |    1      | 2014-08-05 | 推广扫码 | 分组1       |
			| tom1  | 银牌会员    |       2      |     0    |   220.00  |    110.00  |    2      | 2014-08-04 | 直接关注 | 分组1       |
