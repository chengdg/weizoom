...
Background:
	...
	#微信用户批量下订单
		When 微信用户批量消费jobs的商品
			...
			|   0001   | 2015-01-01   | tom1     | 商品1,1   | 支付    | 支付宝   | 10.00   | 100.00 | 110.00      | 110.00 | 0.00   | 0.00  |               | 待发货       |
			|   0002   | 2015-01-02   | tom1     | 商品2,2   |         | 支付宝   | 15.00   | 100.00 | 0.00        | 0.00   | 0.00   | 0.00  | jobs,取消     | 已取消       |
			|   0003   | 2015-02-01   | tom2     | 商品2,2   | 支付    | 支付宝   | 15.00   | 100.00 | 215.00      | 215.00 | 0.00   | 0.00  | jobs,发货     | 已发货       |
			|   0004   | 2015-02-02   | tom2     | 商品1,1   | 支付    | 微信支付 | 10.00   | 100.00 | 110.00      | 0.00   | 110.00 | 0.00  | jobs,完成     | 已完成       |
			|   0005   | 2015-02-04   | tom2     | 商品1,1   |         | 微信支付 | 10.00   | 100.00 | 0.00        | 0.00   | 0.00   | 0.00  |               | 待支付       |
			|   0006   | 2015-03-02   | tom3     | 商品1,1   | 支付    | 货到付款 | 10.00   | 100.00 | 110.00      | 0.00   | 0.00   | 110.00| jobs,完成     | 已完成       |
			|   0007   | 2015-03-04   | tom3     | 商品2,1   | 支付    | 微信支付 | 15.00   | 100.00 | 115.00      | 0.00   | 115.00 | 0.00  | jobs,退款     | 退款中       |
			|   0008   | 2015-03-05   | tom3     | 商品1,1   | 支付    | 支付宝   | 10.00   | 100.00 | 110.00      | 110.00 | 0.00   | 0.00  | jobs,完成退款 | 退款完成     |
...
Scenario:1 默认条件和空条件查询
	...
	#首次进入，默认条件查询
		...
		Then jobs可以获得会员列表
			...
			| bill3 |   普通会员  |       1      |     0    |   0.00    |    0.00    |      0    |        今天       | 会员分享 | 未分组      |
			| bill2 |   普通会员  |       1      |     0    |   0.00    |    0.00    |      0    |        今天       | 直接关注 | 未分组      |
			| bill  |   普通会员  |       1      |     0    |   0.00    |    0.00    |      0    |        今天       | 会员分享 | 未分组      |
