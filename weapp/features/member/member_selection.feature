...
Background:
	...
	#微信用户批量下订单
		When 微信用户批量消费jobs的商品
			...
			|   0001   | 2015-01-01   |   2015-01-01 | tom1     | 商品1,1   | 支付    | 支付宝   | 10      | 100    | 110         | 110    | 0      | 0    |               | 待发货       |
			|   0002   | 2015-01-02   |              | tom1     | 商品2,2   |         | 支付宝   | 15      | 100    | 0           | 0      | 0      | 0    | jobs,取消     | 已取消       |
			|   0003   | 2015-02-01   |   2015-02-01 | tom2     | 商品2,2   | 支付    | 支付宝   | 15      | 100    | 215         | 215    | 0      | 0    | jobs,发货     | 已发货       |
			|   0004   | 2015-02-02   |   2015-04-02 | tom2     | 商品1,1   | 支付    | 微信支付 | 10      | 100    | 110         | 0      | 110    | 0    | jobs,完成     | 已完成       |
			|   0005   | 2015-02-04   |              | tom2     | 商品1,1   |         | 微信支付 | 10      | 100    | 0           | 0      | 0      | 0    |               | 待支付       |
			|   0006   | 2015-03-02   |   2015-03-02 | tom3     | 商品1,1   | 支付    | 货到付款 | 10      | 100    | 110         | 0      | 0      | 110  | jobs,完成     | 已完成       |
			|   0007   | 2015-03-04   |   2015-05-02 | tom3     | 商品2,1   | 支付    | 微信支付 | 15      | 100    | 115         | 0      | 115    | 0    | jobs,退款     | 退款中       |
			|   0008   | 2015-03-05   |   2015-03-05 | tom3     | 商品1,1   | 支付    | 支付宝   | 10      | 100    | 110         | 110    | 0      | 0    | jobs,完成退款 | 退款完成     |
