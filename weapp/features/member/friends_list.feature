...
Background:
	...
	When 微信用户批量消费jobs的商品
		...
		|   0001   | 今天 | bill01   | 商品1,1 | 支付    | 支付宝   | 10.00   |  100.00   | 110.00    | 110.00    | 0.00      | 0.00    |              | 待发货       |
		|   0002   | 今天 | bill01   | 商品1,1 | 支付    | 微信支付 | 10.00   |  100.00   | 110.00    | 0.00      | 110.00    | 0.00    | jobs,发货    | 已发货       |
		|   0003   | 今天 | bill01   | 商品1,1 | 支付    | 货到付款 | 10.00   |  100.00   | 110.00    | 0.00      | 0.00      | 110.00  | jobs,完成    | 已完成       |
		|   0004   | 今天 | bill01   | 商品1,1 | 支付    | 货到付款 | 10.00   |  100.00   | 110.00    | 0.00      | 0.00      | 110.00  | jobs,取消    | 已取消       |
		|   0005   | 今天 | bill13   | 商品1,1 |         | 微信支付 | 10.00   |  100.00   | 110.00    | 0.00      | 0.00      | 0.00    |              | 待支付       |
		|   0006   | 今天 | bill13   | 商品1,1 | 支付    | 微信支付 | 10.00   |  100.00   | 110.00    | 0.00      | 110.00    | 0.00    | jobs,发货    | 已发货       |
		|   0007   | 今天 | bill13   | 商品1,1 | 支付    | 支付宝   | 10.00   |  100.00   | 110.00    | 110.00    | 0.00      | 0.00    | jobs,完成    | 已完成       |
		|   0008   | 今天 | bill13   | 商品1,1 | 支付    | 支付宝   | 10.00   |  100.00   | 110.00    | 110.00    | 0.00      | 0.00    | jobs,完成退款| 退款成功     |
		|   0009   | 今天 | tom1     | 商品1,1 | 支付    | 微信支付 | 10.00   |  100.00   | 110.00    | 0.00      | 110.00    | 0.00    | jobs,发货    | 已发货       |
		|   0010   | 今天 | tom2     | 商品1,1 | 支付    | 支付宝   | 10.00   |  100.00   | 110.00    | 110.00    | 0.00      | 0.00    | jobs,完成    | 已完成       |
		|   0011   | 今天 | tom3     | 商品1,1 | 支付    | 支付宝   | 10.00   |  100.00   | 110.00    | 110.00    | 0.00      | 0.00    | jobs,完成退款| 退款成功     |
...
Scenario:1 会员的好友列表和推荐关注列表
	...
	Then jobs获得'bill'好友列表
		...
		|  bill1   | 普通会员    |    0.00   |     50     | 会员分享 |    bill     |      今天      |
...
Scenario:4 (传播能力)会员的分享链接引流会员列表
	...
	Then jobs获得'bill'分享链接引流会员列表
		...
		|  bill0013| 普通会员    |           |    0.00   |     0      | 会员分享 |      今天      |
		|  bill0011| 普通会员    |           |    0.00   |     0      | 会员分享 |      今天      |
		|  bill13  | 普通会员    |     1     |    110.00 |     0      | 会员分享 |      今天      |
		|  bill11  | 普通会员    |           |    0.00   |     70     | 会员分享 |      今天      |
		|  bill3   | 普通会员    |           |    0.00   |     0      | 会员分享 |      今天      |
		|  bill1   | 普通会员    |           |    0.00   |     50     | 会员分享 |      今天      |
	Given jobs设置分页查询参数
