...
Background:
	...
	And jobs添加优惠券规则
		...
		When 微信用户批量消费jobs的商品
			...
			| 对应订单编号04 | 2015-02-02 |  2015-02-02 | bill     | 商品1,1   | 支付    | 微信支付 | 10      | 100    |          | 优惠券,coupon1_id_1 |                 | 100         | 0      | 100    | 0    | jobs,完成     | 已完成        |
			...
			| 对应订单编号08 | 2015-03-05 |  2015-03-05 | bill     | 商品1,1   | 支付    | 支付宝   | 10      | 100    |          |                     | 0000001,1234567 | 110         | 0      | 0      | 0    | jobs,完成     | 已完成        |
			| 对应订单编号09 | 2015-03-05 |  2015-03-05 | bill     | 商品1,1   | 支付    | 微信支付 | 10      | 100    |  100     |                     |                 | 60          | 0      | 60     | 0    | jobs,完成     | 已完成        |
			| 对应订单编号10 | 2015-03-05 |  2015-03-05 | bill     | 商品1,1   | 支付    | 微信支付 | 10      | 100    |          |                     | 0000003,1234567 | 110         | 0      | 10     | 0    | jobs,完成退款 | 退款完成      |
...
Scenario:1 当前会员的"会员详情"的"购买信息"数据
	...
	Then jobs获得'bill'的订单列表
		...
		|对应订单编号09 |    110.00    | 2015-03-05 | 已完成       |
		|对应订单编号08 |    110.00    | 2015-02-05 | 已完成       |
