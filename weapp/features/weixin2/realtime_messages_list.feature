...
Feature: jobs能看到消息列表信息，包括，分页显示，所有信息，未读信息，未回复，有备注 ，星标信息
		  其中'所有信息，未读信息，未回复'是按照人来显示，即相关选项卡下面，只显示一个粉丝的最后一条消息，其他消息在详情里显示
		  '有备注 ，星标信息',是按照消息内容显示的，即该选项卡下，如果一个粉丝有两天消息，该两条消息都进行了备注，或标注了星标，则，都显示在列表中
...
Background:
	...
	"""
		[{
			...
			"have_read": true,
			"have_replied": true,
	   		"remark": "粉丝44444---------我的备注信息111",
	   		"start": false,
	   		"unread_count": 0,
	   		"fans_name": "粉丝44444",
	   		"inf_content": "信息内容aaaaaaaaa已读，已回复，有备注，没有星标",
	    	"last_message_time": "2015-04-20 13:46:07",
			...
			"have_replied": true,
	   		...
	   		"unread_count": 0,
	   		"fans_name": "粉丝55555",
	   		"inf_content": "粉丝55555---信息内容aaaaaaaaa已读，已回复，有备注，有星标",
	    	"last_message_time": "2015-04-20 14:45:07",
	    	"latest_reply_time": "2015-04-21 11:32:45",
	    	"user_icon": "http://wx.qlogo.cn/mmopen/u83HrgfsuWXdb82iaCNl0vibGdEc1tib22ORvSBpwBW6VQthuweHP4Vp3kCCh1Sr3n39ogfxAhL7XlXxZYgG4e0Ig/0"
		}
	]
