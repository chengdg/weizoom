...
Background:
	...
	#扫码关注成为会员
		When 清空浏览器
		And zhouxun`扫描带参数二维码"带参数二维码-默认设置"于2015-08-11 10:00:00
		And zhouxun`访问jobs的webapp
	...
	#会员购买
		When 微信用户批量消费jobs的商品
			...
			|   0007   | 今天       |   zhouxun`   | 商品1,1 |   支付  |  货到付款 |   10   | 100  |     110      |              |    待发货     |
...
Scenario:7 带参数二维码[关注数量]关注会员列表查询-代言人扫自己的二维码
	...
	Given jobs登录系统
	When tom关注jobs的公众号于'2015-10-12 08:00:00'
