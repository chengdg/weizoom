...
#营销活动分析-'渠道扫码'
@stats.failed @stats.marketing @wip.channel0
...
@stats @stats.marketing @wip.channel1
...
@mall2 @stats @stats.marketing @wip.channel2
