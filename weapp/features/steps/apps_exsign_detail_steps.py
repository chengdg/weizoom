...
@then(u"{webapp_owner_name}获得'{webapp_user_name}'参加专项签到'{webapp_name}'的优惠券明细列表")
...
@when(u"{webapp_owner_name}获得'{webapp_user_name}'参加专项签到'{webapp_name}'的优惠券明细列表默认查询条件")
def step_impl(context, webapp_owner_name, webapp_user_name, webapp_name):
