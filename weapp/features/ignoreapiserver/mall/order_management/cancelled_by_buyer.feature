...
@order @allOrder   @mall.order_cancel_status @mall.order_cancel_status.member
Scenario:1 bill取消订单
	bill取消订单'001'
...
@order @allOrder   @mall.order_cancel_status @mall.order_cancel_status.coupon_member @pyliu
...
@order @allOrder   @mall.order_cancel_status @mall.order_cancel_status.integral_member @pyliu02
...
@order @allOrder   @mall.order_cancel_status @mall.order_cancel_status.integral_and_coupon_member @pyliu
