...
#########################################################################
CARD_SOURCE_STRS = [u'积分兑换', u'返利活动']
CARD_SOURCE_INTEGRAL = 0
CARD_SOURCE_REBATE = 1
class CardHasExchanged(models.Model):
	...
	source = models.IntegerField(default=CARD_SOURCE_STRS[CARD_SOURCE_INTEGRAL]) #微众卡来源（积分兑换 & 返利活动）
